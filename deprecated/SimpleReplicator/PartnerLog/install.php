...
/**
 * Installation script for the 'FetchPartnerLog' extension
 *
 * @author Jean-Lou Dupont
 * $Id$
 */

echo "\n\nFetchPartnerLog database table setup\n\n";
...
$sql = dirname( __FILE__ ) . '/FetchPartnerLog.sql';
...
if( !$dba->tableExists( 'logging_partner' ) ) {
