...
else
{
	if (!class_exists('StubManager'))
		echo "<b>ExtensionManager:</b> missing dependancy [[Extension:StubManager]].\n";	

	if (!class_exists('NamespaceManager'))
		echo "<b>ExtensionManager:</b> missing dependancy [[Extension:NamespaceManager]].\n";	

	if (!defined('EXTENSION_PAGESERVER'))
		echo "<b>ExtensionManager:</b> missing dependancy [[Extension:PageServer]].\n";	

	if (!defined('NS_EXT'))
		echo "<b>ExtensionManager:</b> namespace NS_EXT not defined.\n";	
