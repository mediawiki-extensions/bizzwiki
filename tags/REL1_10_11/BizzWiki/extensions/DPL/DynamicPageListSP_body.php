 ...
 * @version 1.2.2
 *          added parameter "noeditbox" to allow switching off the form
 */
...
class DynamicPageListSP extends SpecialPage
{
		...
		function execute($par) {
		    global $wgOut, $wgRequest, $wgRawHtml, $wgUser, $wgArticlePath;
		    ...
		    if ($wikitext) {
			    ...
			    if ($edit) {
					...
					$wgOut->addHtml("&nbsp; &nbsp; <a href=$wgArticlePath/Special:DynamicPageListSP>reset</a>" .
		        	                "</form>\n");
		    	}
