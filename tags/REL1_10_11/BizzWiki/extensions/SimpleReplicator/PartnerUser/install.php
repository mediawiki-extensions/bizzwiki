...
/**
 * Installation script for the 'FetchPartnerUser' extension
 *
 * @author Jean-Lou Dupont
 * $Id$
 */

echo "\n\nFetchPartnerUser database table setup\n\n";
...
$sql = dirname( __FILE__ ) . '/FetchPartnerUser.sql';
...
if( !$dba->tableExists( 'user_partner' ) ) {
